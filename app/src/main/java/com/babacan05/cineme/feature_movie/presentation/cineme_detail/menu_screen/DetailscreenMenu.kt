...
import com.babacan05.cineme.feature_movie.presentation.cineme_detail.HeartState
...
@Composable
fun DetailScreenMenu(data: TitleDetail, viewModel: DetailViewModel) {
    ...
    fun MiniBox(modifier:Modifier,detailState: State<DetailState>,menustate: Menustate){
        ...
        Box(modifier= modifier.padding(horizontal = when(menustate){
            ACTORS -> 20.dp
            REVIEW -> 0.dp
            MORELIKES -> 20.dp
        })
            .background(Color.Gray.copy(alpha =if(size>70.dp) 1f else 0f
